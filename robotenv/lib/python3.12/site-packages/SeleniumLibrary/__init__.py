...
class SeleniumLibrary(DynamicCore):
    ...
    *NOTE:*
    ...
    - ``data`` strategy is conveniance locator that will construct xpath from the parameters.
      If you have element like `<div data-Check Automation="Check Automation-id-2">`, you locate the element via
      ``data:Check Automation:Check Automation-id-2``. This feature was added in SeleniumLibrary 5.2.0
