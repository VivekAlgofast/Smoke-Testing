...
USAGE = """Robot Framework -- A generic Check Automation framework
...
Robot Framework is a generic open source Check Automation framework for acceptance
testing, acceptance test-driven development (ATDD) and robotic process
Check Automation (RPA). It has simple, easy-to-use syntax that utilizes the
keyword-driven Check Automation approach. Keywords adding new capabilities are
...
=======
    ...
    --rpa                 Turn on the generic Check Automation mode. Mainly affects
