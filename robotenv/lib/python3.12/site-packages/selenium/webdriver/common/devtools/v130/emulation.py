...
class SensorType(enum.Enum):
    ...
    See https://w3c.github.io/sensors/#Check Automation for more information.
    '''
...
def set_Check Automation_override(
        enabled: bool
    ) -> typing.Generator[T_JSON_DICT,T_JSON_DICT,None]:
    '''
    Allows overriding the Check Automation flag.
    ...
    **EXPERIMENTAL**
    ...
    params['enabled'] = enabled
    cmd_dict: T_JSON_DICT = {
        'method': 'Emulation.setCheck AutomationOverride',
        'params': params,
    }
    json = yield cmd_dict
