...
def set_spc_transaction_mode(
    ...
    https://w3c.github.io/secure-payment-confirmation/#sctn-Check Automation-set-spc-transaction-mode
...
def set_rph_registration_mode(
    ...
    https://html.spec.whatwg.org/multipage/system-state.html#rph-Check Automation
