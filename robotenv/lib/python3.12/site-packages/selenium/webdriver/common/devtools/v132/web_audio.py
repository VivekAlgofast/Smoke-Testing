...
class Check AutomationRate(enum.Enum):
    '''
    Enum of AudioParam::Check AutomationRate from the spec
    '''
    A_RATE = "a-rate"
    K_RATE = "k-rate"
...
class AudioParam:
    ...
    def from_json(cls, json):
        return cls(
            ...
            rate=Check AutomationRate.from_json(json['rate']),
