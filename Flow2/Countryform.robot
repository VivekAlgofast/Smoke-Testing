...
country Form Keyword
    ...
    Click Element    xpath=//span[normalize-space()='Country']
    Sleep   3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${country_master_value}
    ...
    ${sql_query}=    Set Variable    SELECT name FROM country_master WHERE name='${name_entered}' LIMIT 1;
...
Edit and Delete country master
    ...
    Click Button    xpath=//button[normalize-space()='Submit']
    Sleep    3s
    #Wait Until Element Is Visible    xpath=//div[@role='gridcell']//button[@type='button']//*[name()='svg']    10s
    Click Element    xpath=//div[@role='gridcell']//button[@type='button']//*[name()='svg']
