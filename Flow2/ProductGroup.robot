...
Product Group master Form Keyword
    ...
    Click Element    xpath=//span[normalize-space()='Product Group']
    Sleep    3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${Product_group_master_value}
    ...
    ${sql_query}=    Set Variable    SELECT name FROM product_group_master WHERE name='${name_entered}' LIMIT 1;
