...
contact group Form Keyword
    ...
    Click Element    xpath=//span[normalize-space()='Contact Group']
    Sleep   3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']   ${contact_group_value} 
    ...
    ${sql_query}=    Set Variable    SELECT name FROM contact_group_master WHERE name='${name_entered}' LIMIT 1;
