...
organisation master Form Keyword
    ...
    Sleep   1s
    Click Element    xpath=//span[normalize-space()='Organization']
    Sleep    3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${Organisation_master_value} 
    ...
    ${sql_query}=    Set Variable    SELECT name FROM organisation_master WHERE name='${name_entered}' LIMIT 1;
