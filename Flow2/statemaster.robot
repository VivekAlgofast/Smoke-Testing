...
State master Form Keyword
    ...
    Mouse Over    xpath=//span[normalize-space()='Region Masters']
    Sleep   1s
    Click Element    xpath=//span[normalize-space()='State']
    Sleep    3s
    ...
    Input Text    xpath=//input[@id='country']    ${country_master_value}
    Sleep    2s
    Press Keys    xpath=//input[@id='country']    ENTER
    Sleep    2s
    Click Element    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${State_master_value}
    ...
    ${sql_query}=    Set Variable    SELECT name FROM state_master WHERE name='${name_entered}' LIMIT 1;
