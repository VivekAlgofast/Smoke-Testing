...
Area master Form Keyword
    ...
    Sleep   1s
    Click Element    xpath=//span[normalize-space()='Area']
    Wait Until Element Is Visible    xpath=//div[contains(text(),'Name')]
    Sleep   3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${Area_value}
    ...
    ${sql_query}=    Set Variable    SELECT name FROM area_master WHERE name='${name_entered}' LIMIT 1;
