...
Product unit master Form Keyword
    ...
    Click Element    xpath=//span[normalize-space()='Product Unit']
    Sleep    3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${Product_unit_master_value}
    ...
    ${sql_query}=    Set Variable    SELECT name FROM unit_master WHERE name='${name_entered}' LIMIT 1;
