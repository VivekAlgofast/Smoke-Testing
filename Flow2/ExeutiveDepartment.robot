...
Executivedept master Form Keyword
    ...
    Click Element    xpath=//span[normalize-space()='Department']
    Sleep    3s
    Click Button    xpath=//button[normalize-space()='Add New']
    Wait Until Element Is Visible    xpath=//input[@id='name']
    Input Text    xpath=//input[@id='name']  ${Executive_department_master_value} 
    ...
    ${sql_query}=    Set Variable    SELECT name FROM executive_dept_master WHERE name='${name_entered}' LIMIT 1;
